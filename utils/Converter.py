...
class Converter:
    ...
    def SplitRecords(self,dataRows):
        ...
        for eachDataRow in dataRows:
            ...
            if eachDataRow != "":
                if self.CheckIfTelephoneNumber(eachDataRow) is True or (i == 434 and eachDataRow == "1-866-CALL-IRA") or ( i == 599 and eachDataRow == "1-888-70-PORSCHE"):
